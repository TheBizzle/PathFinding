package com.AStar.datastructure.heap

import com.AStar.coordinate.PriorityCoordinate
 ...
 * Time: 3:50 PM
 */
class Heap[T : Manifest] protected (ordering: (T, T) => Int, elemArr: Array[Option[T]]) {
